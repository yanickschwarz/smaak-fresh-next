...
export const metadata: Metadata = {
  ...
  description:
    "Burger@Home von smaak! fresh: Burgerfleisch von der Metzg Thalmann, Brötchen vom Beck Ruckli, Bio-Salat vom BIOmobil. Klein 100g CHF 6.50, Gross 120g CHF 7.00.",
